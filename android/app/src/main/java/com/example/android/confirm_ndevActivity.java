...
public class confirm_ndevActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.confire_login_hander = new Handler() {
            public void handleMessage(Message message) {
                ...
                try {
                    switch (what) {
                        case confirm_ndevActivity.CONFIRM_LOGIN_FINISHED:
...
//                            toast.show();//显示消息提示框
    ...
    public void onClick(View view) {
        ...
        if(vid==this.confire_login.getId()) {
            authorization();
            Intent intent = new Intent(confirm_ndevActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
